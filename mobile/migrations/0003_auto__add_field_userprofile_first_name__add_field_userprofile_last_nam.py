...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'mobile_userprofile', 'first_name',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.last_name'
        db.add_column(u'mobile_userprofile', 'last_name',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'mobile_userprofile', 'first_name')

        # Deleting field 'UserProfile.last_name'
        db.delete_column(u'mobile_userprofile', 'last_name')
    ...
    models = {
        ...
        u'mobile.userprofile': {
            ...
            'num_bars_visited': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
